...
//  Portal
//
//  Created by Kaelen Guthrie on 11/12/18.
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func setupScene() {
        ...
        leftWall.eulerAngles = SCNVector3(0,180.0.degreesToRadians,0)
        ...
        topWall.eulerAngles = SCNVector3(0,0,90.0.degreesToRadians)
        
        let bottomWall = createBox(isDoor: false)
        bottomWall.position = SCNVector3(0,(-height/2) + width,0)
        bottomWall.eulerAngles = SCNVector3(0,0,-90.0.degreesToRadians)
        
        let backWall = createBox(isDoor: false)
        backWall.position = SCNVector3(0,0, (-length/2) + width)
        backWall.eulerAngles = SCNVector3(0,90.0.degreesToRadians, 0)
        
        let leftDoorSide = createBox(isDoor: true)
        leftDoorSide.position = SCNVector3((-length/2)+(doorLength/2),0,length/2)
        leftDoorSide.eulerAngles = SCNVector3(0,-90.0.degreesToRadians,0)
        
        let rightDoorSide = createBox(isDoor: true)
        rightDoorSide.position = SCNVector3((length/2)-(doorLength/2),0,length/2)
        rightDoorSide.eulerAngles = SCNVector3(0,-90.0.degreesToRadians,0)
